...
- **Cloud Infrastructure**: AWS EC2 (t4g.small) managed via Coolify.
- **Database**: Supabase (PostgreSQL) with Realtime replication.
- **Market Data Source**: Binance WebSocket API.
...
- **Environment**: Managed via Coolify, providing automated CI/CD from GitHub.
